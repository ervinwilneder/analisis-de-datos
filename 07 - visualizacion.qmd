...
- Vizualización de cantidades, proporciones y distribuciones
    ...
    - [Exploratory Visualizations (_Feature Engineering and Selection: A Practical Approach for Predictive Models: cap. 4_)](http://www.feat.engineering/exploratory-visualizations.html)
    - [Data Visualization (_Python for Everybody: cap. 17_)](https://www.py4e.com/lessons/dataviz)
...
- Conceptos básicos de storytelling y presentaciones efectivas
    ...
    - [Data Visualization - A practical introduction (Cap. 1)](https://socviz.co/lookatdata.html#lookatdata)
